...
public class MakePrivate extends AbstractChangeModifiers {
    ...
    public static ErrorDescription convert(HintContext ctx) {
        ...
        return forSpan(ErrorDescriptionFactory.forName(ctx, path, Bundle.ERR_MakePrivate(), fix), span[0], span[1]);
    }
}
