...
"	at org.netbeans.api.editor.document.LineDocumentUtils.createDocument(LineDocumentUtils.java:554)")
    @Test
...
"	at org.netbeans.api.editor.document.LineDocumentUtils.createDocument(LineDocumentUtils.java:554)")
    @Test
    public void testToIfElseAssignWithoutBrackets() throws Exception {
        HintTest.create()
                .setCaretMarker('|')
                .input("package test;\n"
                        + "public class Test {\n"
                        ...
                        + "}\n")
                .run(ToTernary.class)
                .findWarning("4:13-4:13:hint:" + Bundle.ERR_ToIfElseAssign())
                .applyFix()
                .assertCompilable()
                .assertOutput("package test;\n"
                        + "public class Test {\n"
    ...
    @Test
    public void testToIfElseAssignNewVariableWithoutBrackets() throws Exception {
        HintTest.create()
                .setCaretMarker('|')
                .input("package test;\n"
                        + "public class Test {\n"
                        ...
                        + "}\n")
                .run(ToTernary.class)
                .findWarning("3:17-3:17:hint:" + Bundle.ERR_ToIfElseAssign())
                .applyFix()
                .assertCompilable()
                .assertOutput("package test;\n"
                        + "public class Test {\n"
